          ...
          <form action="" method="get">
            <div class="user-details">
              ...
              <div class="input-box">
                ...
                <input type="text" value="<?php echo "$sname";  ?>" name="sname" required>
              </div>

              <div class="input-box">
                <span class="details">Start of Semester</span>
                <input type="date" value="<?php echo "$SoS";  ?>" name="SoS" required>
              </div>

              <div class="input-box">
                <span class="details">End of Semester</span>
                <input type="date" value="<?php echo "$EoS";  ?>" name="EoS" required>
              </div>
...
if ($_GET['submit']) {
  ...
  $query = "UPDATE semesters SET Semesters='$sname', StartOfSemester='$SoS', EndOfSemester='$EoS' WHERE Semesters='$sname' or StartOfSemester = '$SoS' and EndOfSemester = '$EoS'";
