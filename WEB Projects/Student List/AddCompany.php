              ...
              <form action="insertCompany.php" method="post">
                <div class="user-details">
                  ...
                  <div class="input-box">
                    ...
                    <input type="text" id ="ccellphone" name="ccellphone"  required>
                  </div>
                  ...
                  <div class="input-box">
                    ...
                    <input type="text" id ="cmanager" name="cmanager" required>
                  </div>


                  <div class="input-box">
                    <span class="details">Manager Phone Number</span>
                    <input type="text" id ="mcellphone" name="mcellphone" required>
                  </div>
